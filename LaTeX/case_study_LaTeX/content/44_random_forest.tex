...
\begin{table}[htbp]
    ...
    \multicolumn{1}{|l|}{\cellcolor[HTML]{EFEFEF}none}                       & \multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}1.000} & 0.589                                             & \multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}1.000} & 0.888                                             & \multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}1.000} & 0.555                                             \\ \hline
    \multicolumn{1}{|l|}{\cellcolor[HTML]{EFEFEF}+ 1. Hp Tuning} & \multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}0.630} & 0.493                                             & \multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}0.954} & 0.531                                             & \multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}0.589} & 0.478                                             \\ \hline
    \multicolumn{1}{|l|}{\cellcolor[HTML]{EFEFEF}+ Balancing}                & \multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}0.934} & 0.610                                             & \multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}0.936} & 0.575                                             & \multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}0.935} & 0.708                                             \\ \hline
    \multicolumn{1}{|l|}{\cellcolor[HTML]{EFEFEF}+ Feature Selection}        & \multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}0.938} & 0.609                                             & \multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}0.940} & 0.574                                             & \multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}0.939} & 0.705                                             \\ \hline
    \multicolumn{1}{|l|}{\cellcolor[HTML]{EFEFEF}+ 2. Hp Tuning} & \multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}0.966} & 0.636                                             & \multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}0.967} & 0.6  00                                           & \multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}0.966} & 0.709                                             \\ \hline
\end{tabular}
...
%The hyperparameters change to a maximal depth of the trees of 13 and the number of total trees of 700. All other hyperparameters remain equal. 
