...
\begin{table}[h!]
    ...
    \multicolumn{1}{|l|}{\cellcolor[HTML]{EFEFEF}6}      & \multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}+balancing}       & \multicolumn{1}{c|}{\cellcolor[HTML]{FFFFFF}16}                                        & \multicolumn{1}{c|}{\cellcolor[HTML]{FFFFFF}8}               & \multicolumn{1}{c|}{\cellcolor[HTML]{FFFFFF}2.048}               & \multicolumn{1}{c|}{\cellcolor[HTML]{FFFFFF}80}                             \\ \hline
\end{tabular}
...
\begin{table}[h!]
    ...
    \multicolumn{1}{|l|}{\cellcolor[HTML]{EFEFEF}1}                     & \multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}0.406} & 0.434                                            \\ \hline
    \multicolumn{1}{|l|}{\cellcolor[HTML]{EFEFEF}2}           & \multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}0.707} & 0.456                                             \\ \hline
    \multicolumn{1}{|l|}{\cellcolor[HTML]{EFEFEF}3}              & \multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}0.738} & 0.487                                             \\ \hline
    \multicolumn{1}{|l|}{\cellcolor[HTML]{EFEFEF}4}      & \multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}0.761} & 0.544                                             \\ \hline
    \multicolumn{1}{|l|}{\cellcolor[HTML]{EFEFEF}5}           & \multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}0.820} & 0.553                                             \\ \hline
    \multicolumn{1}{|l|}{\cellcolor[HTML]{EFEFEF}6}           & \multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}0.851} & 0.567                                             \\ \hline
\end{tabular}
\caption{Neural network -- Predictions}
\label{tab:nn_pred}
\end{table}

Neural networks (NNs), also known as artificial neural networks (ANNs), are one of the prominent applications of machine learning (ML). It is supposed to emulate the learning process of the human brain by connecting artificial neurons and giving these connections a certain weight. Adjusting these weights is the \enquote{learning part} of the algorithm. \citep[][p. 326]{Aggarwal2015}, \citep[][p. 247]{TanPang-Ning2006}
